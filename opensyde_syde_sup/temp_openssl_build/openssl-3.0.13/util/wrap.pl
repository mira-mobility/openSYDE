...
BEGIN {
    ...
    require '/Users/oleksandrturevskiy/projects/Ansible3.3/openSYDE/opensyde_syde_sup/temp_openssl_build/openssl-3.0.13/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/oleksandrturevskiy/projects/Ansible3.3/openSYDE/opensyde_syde_sup/temp_openssl_build/openssl-3.0.13/test/fips-and-base.cnf';
    shift;
